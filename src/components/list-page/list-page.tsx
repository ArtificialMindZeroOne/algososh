...
export const ListPage: React.FC = () => {
  const minLength = LIST_MIN_LENGTH;
  const maxLength = LIST_MAX_LENGTH;
  ...
  const arrInit = React.useMemo(() => getRandomArr(minValue, maxValue, minLength, maxLength), [maxLength, maxValue, minLength, minValue]);
