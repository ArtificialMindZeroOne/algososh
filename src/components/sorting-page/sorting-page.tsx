...
export const SortingPage: React.FC = () => {
  const minLength = ARRAY_MIN_LENGTH;
  const maxLength = ARRAY_MAX_LENGTH;
  ...
  const arrInit = getRandomArr(minValue, maxValue, minLength, maxLength);
  ...
  const renderNewArray = (e: MouseEvent<HTMLButtonElement>) => {
    setLoadingState(e);
    setArrToRender({
      currentArray: [...getRandomArr(minValue, maxValue, minLength, maxLength)],
      indexI: null,
      indexJ: null,
      sortedRange: [],
    });
